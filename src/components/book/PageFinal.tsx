  ...
  return (
    <PageFrame pageNumber="VII">
      <div className="flex flex-col items-center justify-center h-full gap-3 sm:gap-5 fade-up text-center">
        ...
        <h2 className="font-display text-[20px] sm:text-[26px] tracking-[0.06em] uppercase leading-tight text-[var(--emerald)] max-w-[280px]">
          O melhor ainda está por vir.
        </h2>
        <div className="gold-line w-20 sm:w-24" />
        <p className="font-serif italic text-[var(--ink)] text-[12px] sm:text-sm max-w-[260px]">
