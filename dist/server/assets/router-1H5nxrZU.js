...
const appCss = "/assets/styles-CosJnQIZ.css";
...
const Route$1 = createRootRouteWithContext()(
  {
    head: () => ({
      meta: [
        ...
        {
          name: "description",
          content: "21 de Novembro de 2026 — Uma nova história está prestes a começar."
        },
...
const $$splitComponentImporter = () => import("./index-ClDS9CW5.js").then((n) => n.i);
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      property: "og:title",
      content: "Alleane & Rafael — Save the Date"
    }, {
      property: "og:description",
